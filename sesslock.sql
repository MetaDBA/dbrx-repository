...
col blk_sid form a9       heading "Blocking|Inst:SID"
col fin_sid form a8       heading "FinalBlkg|Inst:SID"
...
select inst_id||':'||sid inst_sid , serial#, username, row_wait_obj#, row_wait_file#, row_wait_block#, row_wait_row#,
 sql_hash_value, blocking_instance || ':' || blocking_session blk_sid, final_blocking_instance || ':' || final_blocking_session fin_sid, 
