...
col total_mb format 999,999,999 heading "MB"
...
col pct_io format 9,999.99 heading "Pct|IO"
col pct_time format 9,999.99 heading "Pct|Time"
set pagesize 10000
set lines 100
set verify off
set echo on
...
SELECT d.name,
       d.PATH disk_path, d.total_mb,
       ROUND(ds.read_secs * 1000 / ds.reads, 2) avg_read_ms,
       ROUND(ds.write_secs * 1000 / ds.writes, 2) avg_write_ms,
