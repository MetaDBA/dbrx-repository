...
where  b.event = a.event
  ...
  and  100*((b.time_waited-a.time_waited)/(&tot_time_waited+.000001-&old_tot_time_waited)) > 0.01
...
drop table system_event_snap purge;
drop table system_event_snap_date purge;
