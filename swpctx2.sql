...
select 'Sample interval was ' || round(avg(sysdate - a.sample_date)*86400) || ' seconds. CPU used was ' 
	...
	from system_event_snap_date2 a, v$sysstat b
...
drop table system_event_snap2 purge;
drop table system_event_snap_date2 purge;
create table system_event_snap2 as select * from v$system_event;
create table system_event_snap_date2 (sample_date,cpu)
